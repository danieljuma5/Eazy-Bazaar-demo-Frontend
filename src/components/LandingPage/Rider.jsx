...
const Rider = ({ orders, setOrders }) => {
  ...
  const riders = [
    { id: 1, name: 'Dummy Rider 1', contact: '1234567890', logoUrl: '/path/to/logo1.png' },
    { id: 2, name: 'Dummy Rider 2', contact: '9876543210', logoUrl: '/path/to/logo2.png' },
    { id: 3, name: 'Dummy Rider 3', contact: '5555555555', logoUrl: '/path/to/logo3.png' },
  ];
